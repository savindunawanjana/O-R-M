...
public interface LessionShedulDAO extends CrudDAO<LessionsEntyty> {
    ...
    boolean savemethod(LessionsEntyty entyty) throws Exception;
    List<LessionsEntyty> getReleventLessionObjects(String courseId, String date, String time, String instroctorId)throws Exception;
}
